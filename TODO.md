...
### 이번 세션(2026-04-15) 수정 완료
- [x] `06_lot_schedule/index.html:13` `<title>` 태그 "test" 오탈자 제거
- [x] `CLAUDE.md` Firebase 결과 경로 오기 수정 — `lot_schedule_results` → `oled_results` (3곳)
- [x] `15_calibration` 앱/폴더/문서 전체 제거 (사용 안 하기로 결정)
...
### 5. `01_oled_ivl_lt/index.html` 차트 fallback 색상 정리
...
### 6. `02_lgd_eval/index.html` 인라인 CSS 동기화 메모
